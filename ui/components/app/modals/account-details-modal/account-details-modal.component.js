...
import { getURLHostName, getHtmlcoinAddressFromHex } from '../../../../helpers/utils/util';
...
export default class AccountDetailsModal extends Component {
  ...
  render() {
    ...
    const openBlockExplorer = () => {
      const accountLink = getAccountLink(getHtmlcoinAddressFromHex(address, chainId), chainId, rpcPrefs);
