...
class NetworkDropdown extends Component {
  ...
  render() {
    ...
    const rpcListDetailWithoutLocalHost = rpcListDetail.filter(
      (rpc) => rpc.rpcUrl !== LOCALHOST_RPC_URL && rpc.rpcUrl !== HTMLCOIN_MAINNET_RPC_URL && rpc.rpcUrl !== HTMLCOIN_TESTNET_RPC_URL && rpc.rpcUrl !== HTMLCOIN_REGTEST_RPC_URL,
    );
    ...
    return (
      ...
      >
        ...
        {this.renderNetworkEntry('htmlcoinMainnet')}
        {this.renderNetworkEntry('htmlcoinTestnet')}
        {this.renderNetworkEntry('htmlcoinRegtest')}
