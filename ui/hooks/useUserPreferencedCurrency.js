...
import { PRIMARY, SECONDARY, ETH, HTMLCOIN } from '../helpers/constants/common';
...
export function useUserPreferencedCurrency(type, opts = {}) {
  ...
  if (
    ...
    // Display ETH
    currency = nativeCurrency || HTMLCOIN;
    numberOfDecimals = opts.numberOfDecimals || opts.ethNumberOfDecimals || 8; // HTMLCOIN: or 6?
  } else if (
    (type === SECONDARY && useNativeCurrencyAsPrimaryCurrency) ||
    (type === PRIMARY && !useNativeCurrencyAsPrimaryCurrency)
  ) {
