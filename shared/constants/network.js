...
export const HTMLCOIN_MAINNET = 'htmlcoinMainnet';
export const HTMLCOIN_TESTNET = 'htmlcoinTestnet';
export const HTMLCOIN_REGTEST = 'htmlcoinRegtest';
...
export const HTMLCOIN_MAINNET_NETWORK_ID = '81';
export const HTMLCOIN_TESTNET_NETWORK_ID = '8889';
export const HTMLCOIN_REGTEST_NETWORK_ID = '8890';
...
export const HTMLCOIN_MAINNET_CHAIN_ID = '0x51';
export const HTMLCOIN_MAINNET_ID = '89';
export const HTMLCOIN_TESTNET_CHAIN_ID = '0x22B9';
export const HTMLCOIN_TESTNET_ID = '8889';
export const HTMLCOIN_REGTEST_CHAIN_ID = '0x22BA';
export const HTMLCOIN_REGTEST_ID = '8890';
...
export const HTMLCOIN_MAINNET_DISPLAY_NAME = 'HTMLCOIN Mainnet';
export const HTMLCOIN_TESTNET_DISPLAY_NAME = 'HTMLCOIN Testnet';
export const HTMLCOIN_REGTEST_DISPLAY_NAME = 'HTMLCOIN Regtest';
...
export const HTMLCOIN_MAINNET_RPC_URL = `https://janus.qiswap.com/api/`;
export const HTMLCOIN_TESTNET_RPC_URL = `https://testnet-janus.qiswap.com/api/`;
export const HTMLCOIN_REGTEST_RPC_URL = `https://localhost:23889`;
...
export const HTMLCOIN_SYMBOL = 'HTMLCOIN';
...
export const HTMLCOIN_TOKEN_IMAGE_URL = './images/htmlcoin_logo.png';
...
export const HTMLCOIN_PROVIDER_TYPES = [HTMLCOIN_MAINNET, HTMLCOIN_TESTNET, HTMLCOIN_REGTEST];
...
export const NETWORK_TYPE_TO_ID_MAP = {
  ...
  [HTMLCOIN_MAINNET]: {
    networkId: HTMLCOIN_MAINNET_NETWORK_ID,
    chainId: HTMLCOIN_MAINNET_CHAIN_ID,
    ticker: HTMLCOIN_SYMBOL,
  },
  [HTMLCOIN_TESTNET]: {
    networkId: HTMLCOIN_TESTNET_NETWORK_ID,
    chainId: HTMLCOIN_TESTNET_CHAIN_ID,
    ticker: HTMLCOIN_SYMBOL,
  },
  [HTMLCOIN_REGTEST]: {
    networkId: HTMLCOIN_REGTEST_NETWORK_ID,
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [HTMLCOIN_MAINNET]: HTMLCOIN_MAINNET_DISPLAY_NAME,
  [HTMLCOIN_TESTNET]: HTMLCOIN_TESTNET_DISPLAY_NAME,
  [HTMLCOIN_REGTEST]: HTMLCOIN_REGTEST_DISPLAY_NAME,

  [HTMLCOIN_MAINNET_NETWORK_ID]: HTMLCOIN_MAINNET_DISPLAY_NAME,
  [HTMLCOIN_TESTNET_NETWORK_ID]: HTMLCOIN_TESTNET_DISPLAY_NAME,
  [HTMLCOIN_REGTEST_NETWORK_ID]: HTMLCOIN_REGTEST_DISPLAY_NAME,

  [HTMLCOIN_MAINNET_CHAIN_ID]: HTMLCOIN_MAINNET_DISPLAY_NAME,
  [HTMLCOIN_TESTNET_CHAIN_ID]: HTMLCOIN_TESTNET_DISPLAY_NAME,
  [HTMLCOIN_REGTEST_CHAIN_ID]: HTMLCOIN_REGTEST_DISPLAY_NAME,
};
...
export const CHAIN_ID_TO_RPC_URL_MAP = {
  ...
  [HTMLCOIN_MAINNET_CHAIN_ID]: HTMLCOIN_MAINNET_RPC_URL,
  [HTMLCOIN_TESTNET_CHAIN_ID]: HTMLCOIN_TESTNET_RPC_URL,
  [HTMLCOIN_REGTEST_CHAIN_ID]: HTMLCOIN_REGTEST_RPC_URL,
};
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [HTMLCOIN_MAINNET_CHAIN_ID]: HTMLCOIN_TOKEN_IMAGE_URL,
};
...
export const NETWORK_ID_TO_ETHERS_NETWORK_NAME_MAP = {
  ...
  [HTMLCOIN_MAINNET_ID]: HTMLCOIN_MAINNET,
  [HTMLCOIN_TESTNET_ID]: HTMLCOIN_TESTNET,
  [HTMLCOIN_REGTEST_ID]: HTMLCOIN_REGTEST,
};
...
export const NATIVE_CURRENCY_TOKEN_IMAGE_MAP = {
  ...
  [HTMLCOIN_SYMBOL]: HTMLCOIN_TOKEN_IMAGE_URL,
